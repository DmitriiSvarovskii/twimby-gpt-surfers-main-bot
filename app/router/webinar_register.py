...
# async def webinar_register(callback: CallbackQuery):
#     webinar_id = int(callback.data.split(":")[-1])

#     # тут дальше твоя логика записи в БД (webinar_registrations)
#     await callback.answer(f"Ок, регистрирую на вебинар #{webinar_id}", show_alert=True)
# # from aiogram import Router, F, Bot
